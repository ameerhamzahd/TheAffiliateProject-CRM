...
const AddLeadButton = () => {
    return (
        <div>
            <a className='text-xs md:text-[1rem] w-[125px] h-[45px] md:w-[155px] md:h-[50px] text-[#FFFFFF] border border-white rounded-[10px] flex items-center justify-center gap-[10px] transition-all duration-300 hover:bg-white hover:text-black hover:shadow-[0px_4px_4px_0px_rgba(255,255,255,0.25),0px_-4px_4px_0px_rgba(255,255,255,0.25),4px_0px_4px_0px_rgba(255,255,255,0.25),-4px_0px_4px_0px_rgba(255,255,255,0.25)] cursor-pointer'>
                ...
                <span className='font-sf'>Add new lead</span>
            </a>
        </div>
    );
};
